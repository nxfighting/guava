...
public class VictBloomFilter<E> implements Serializable {
     ...
     */
    public VictBloomFilter(double c, int n, int k) {
     ...
     */
    public VictBloomFilter(int bitSetSize, int expectedNumberOElements) {
     ...
     */
    public VictBloomFilter(double falsePositiveProbability, int expectedNumberOfElements) {
     ...
     */
    public VictBloomFilter(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, BitSet filterData) {
    ...
    public boolean equals(Object obj) {
        ...
        final VictBloomFilter<E> other = (VictBloomFilter<E>) obj;
